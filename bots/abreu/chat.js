...
function initChat() {
    ...
    const startingColor = "#E84E24";
    const displayClassName = "display";
    const hideClassName = "hide";

    const appKey = "YWJyZXVpbW92ZWlzOjAwOTY4YTZmLTI2ZTEtNDQ2NC04ZDQxLTJiMmUzODBjMjE5Ng==";

    const topImage = "https://abreuimoveis.com.br/media/abreuimoveis/2022/01/Pim-Abreu-logo-Natal-RN.png";
